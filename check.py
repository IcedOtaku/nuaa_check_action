...
def send_result(config, recever, result, messgae):
    ...
    if result == True:
        send_mail(mail_sender, smtp_password, smtp_host, recever, messgae, '打卡成功', '主人', '然然打卡机')
    else:
        send_mail(mail_sender, smtp_password, smtp_host, recever, messgae, '打卡失败', '主人', '然然打卡机')
